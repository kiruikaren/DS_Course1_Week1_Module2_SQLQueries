...
df_hungry = pd.read_sql("""
        SELECT name, age, breed FROM dogs WHERE hungry == 1 ORDER BY age;
""", conn2)
df_hungry
# CodeGrade step7
# Replace None with your code
df_hungry_ages = pd.read_sql("""
        SELECT name, age, hungry FROM dogs WHERE age BETWEEN 2 AND 7 ORDER BY name;
""", conn2)
df_hungry_ages
# CodeGrade step8
# Replace None with your code
...
SELECT COUNT(year) FROM babe_ruth_stats; """, conn3)
